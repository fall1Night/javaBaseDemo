...
public class WordWaterMarker {
    ...
    public static void main(String[] args) throws IOException, XmlException {
        ...
        WordWaterMarker wordWaterMarker = new WordWaterMarker("水印水印");
        wordWaterMarker.makeSlopeWaterMark(in, out);
        in.close();
        out.close();
    }
    ...
    /**
     * 为文档添加水印<br />
     * 实现参考了 @link org.apache.poi.xwpf.model.XWPFHeaderFooterPolicygetWatermarkParagraph(String, int)
     *
